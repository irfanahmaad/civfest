          ...
          <div class="container">
            <div class="col-xs-12">
              <div class="logo-event">
                ...
                <h1>Lomba Konstruksi Jembatan</h1>
              </div>
            </div>
          </div>
        	</section>
        		...
        		<div class="container-fluid">
        			<div class="row">
        				<div class="main-breadcrumb col-xs-12">
        					<p><a href="{{ url('/') }}">Home</a> <i class="fa fa-angle-right" aria-hidden="true"></i> <a href="{{ url('event') }}">Event</a> <i class="fa fa-angle-right" aria-hidden="true"></i>Lomba Konstruksi Jembatan</p>
        				</div>
        			</div>
        		</div>
        	</section>
